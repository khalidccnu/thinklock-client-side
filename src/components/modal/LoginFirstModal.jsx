...
const LoginFirstModal = ({ isLFMOpen, setLFMOpen }) => {
  const navigate = useNavigate();

  return (
    <Transition appear show={isLFMOpen} as={Fragment}>
      <Dialog
        as="div"
        className="relative z-10"
        onClose={(_) => setLFMOpen(false)}
      >
        <Transition.Child
          as={Fragment}
              ...
              <Dialog.Panel className="bg-blue-prussian max-w-md p-6 rounded-2xl shadow-xl transition-all">
                ...
                <div className="mt-2">
                  <p className="text-sm text-gray-300">
                    Only registered user can book this course. Please, login
                    first!
                  </p>
                </div>
